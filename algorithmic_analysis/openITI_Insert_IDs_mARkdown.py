...
def reflowMdSimple(inputFile):
    with open(inputFile, "r", encoding="utf8") as f1:
        ...
        with open(inputFile, "w", encoding="utf8") as f9:
            f9.write(final)
...
# ../data/0812CaliKhazraji/0812CaliKhazraji.CuqudLuluiyya/0812CaliKhazraji.CuqudLuluiyya.Mahoney20180308-ara1.mARkdown
